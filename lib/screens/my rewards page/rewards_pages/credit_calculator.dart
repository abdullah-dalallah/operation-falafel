                              ...
                              child: SizedBox(
                                ...
                                child:   TextField(
                                  ...
                                  decoration:  InputDecoration(
                                    ...
                                    hintText: '',
                                    label: Text(getTranslated(context, "enterAmount")!, style: TextStyle(fontFamily:getTranslated(context, "fontFamilyBody")!, color: Colors.white38),),
                                  ),
                                 onChanged: (value){
                                    if(value.isNotEmpty){
                              ...
                              child: SizedBox(
                                ...
                                child:   TextField(
                                  ...
                                  decoration:  InputDecoration(
                                    ...
                                    hintText: '',
                                    label: Text(getTranslated(context, "earned credits")!, style: TextStyle(fontFamily:getTranslated(context, "fontFamilyBody")!, color: Colors.white38),),
