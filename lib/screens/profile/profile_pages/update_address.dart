                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          decoration:  InputDecoration(
                            ...
                            label: Text(getTranslated(context, "addressLine")!, style: TextStyle(fontFamily:getTranslated(context, "fontFamilyBody")!, color: Colors.white38),),
                            ...
                            Expanded(
                              ...
                              child: TextField(
                                ...
                                decoration:  InputDecoration(
                                  ...
                                  label: Text(getTranslated(context, "buildingName")!, style: TextStyle(fontFamily:getTranslated(context, "fontFamilyBody")!, color: Colors.white38),),
                            ...
                            Expanded(
                              ...
                              child: TextField(
                                ...
                                decoration:  InputDecoration(
                                  ...
                                  label: Text(getTranslated(context, "villa")!, style: TextStyle(fontFamily:getTranslated(context, "fontFamilyBody")!, color: Colors.white38),),
                            ...
                            Expanded(
                              ...
                              child: TextField(
                                ...
                                decoration:  InputDecoration(
                                  ...
                                  label: Text(getTranslated(context, "area")!, style: TextStyle(fontFamily:getTranslated(context, "fontFamilyBody")!, color: Colors.white38),),
                        ...
                        child: Row(children: [
                          ...
                          SizedBox(
                              ...
                              child: ElevatedButton(
                                  ...
                                  child: Text(getTranslated(context, "updateAddress")!,style: TextStyle(fontFamily: getTranslated(context, "fontFamilyBody")!,color: Colors.white, fontSize: 14),)
