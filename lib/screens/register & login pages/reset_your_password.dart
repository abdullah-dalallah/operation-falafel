                ...
                Expanded(
                  child: ListView(
                    children: [
                      ...
                      Text(getTranslated(context, "resetYourPassword")!, style: TextStyle(fontFamily: getTranslated(context, "fontFamilyButtons"),color: Colors.amber,fontSize: double.parse(getTranslated(context, "welcomeBackTitle")!),height: 1),textAlign: TextAlign.center,),
