...
class PlacingLoyaltyOrderModel extends StatefulWidget{
  late BuildContext checkOutScreenContext;

  PlacingLoyaltyOrderModel(this.checkOutScreenContext,{Key? key}) : super(key: key);

  @override
  State<PlacingLoyaltyOrderModel> createState() => _PlacingLoyaltyOrderModelState();
}

class _PlacingLoyaltyOrderModelState extends State<PlacingLoyaltyOrderModel> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text("Credit Card",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white54, fontFamily: getTranslated(context, "fontFamilyBody", )!,fontSize: 13),)
                      ],),
                    SizedBox(height: 10,),
                    ...
                    ListTile(
                      ...
                      title:  Text("Voucher", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.white54, fontFamily: getTranslated(context, "fontFamilyBody", )!),),
                      subtitle:

                      Text("Free Delivdery. Min order AED 30\n",
