...
class _SchedulePickUpWidgetState extends State<SchedulePickUpWidget> {
            ...
            Padding(
              ...
              child: Row(
                children: [
                  TextButton(
                    onPressed: () {
                      double latitude = 25.076732 ;  // Replace with your desired latitude
                      double longitude = 55.132389;  // Replace with your desired longitude
                      openGoogleMaps();

                    },
                    child: Row(
                      children: [
                        Icon(Icons.directions,color: Colors.amber.shade100, size: 14,),
                        SizedBox(width: 5,),
                        Text(
                          "Directions (4.3 km)",
                  ...
                  SizedBox(height :15,child: VerticalDivider(width: 15, color: Colors.grey,)),
                  TextButton(
                    onPressed: () {
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.phone,color: Colors.amber.shade100, size: 14,),
                        SizedBox(width: 5,),
                        Text(
                          "Call Restaurant",
                          style: TextStyle(color: Colors.amber.shade100, fontWeight: FontWeight.bold,  fontFamily: "Raleway-Regular", fontSize: 13),
  ...
  void openGoogleMaps() async {
    final String googleMapsUrl = 'https://goo.gl/maps/Hxp4kgERXkF47DAj6';
