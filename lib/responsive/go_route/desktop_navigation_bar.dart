...
class DesktopNavigationBar extends StatefulWidget{
  ...
  const DesktopNavigationBar({
    ...
    required this.onDesktopLayOutSelected
  });
  final Widget body;
  final int selectedIndex;
  final ValueChanged<int> onDestinationSelected;
  final ValueChanged<int> onDesktopLayOutSelected;
...
class _DesktopNavigationBarState extends State<DesktopNavigationBar> {
     ...
     return  Scaffold(
       body: Row(
         children: [
           Expanded(
               flex: 2,
               child: DrawerWidget(layOut: "", onChanged: (value) {},)),
           Expanded(
               flex: 3,
               child: widget.body),
           // Expanded(
           //     flex: 2,
           //     child: Cart_Screen(layOut: "", (value) => {})),
         ],
       ),
  ...
  void initState() {
    super.initState();
    // return widget.onDesktopLayOutSelected(2);
  }
}